...
<?php get_header(); ?> 
<div class="titelplaatje titelresponsive">
                	...
                	<div class="u-gridContainer">
                        <article class="u-gridRow youtube" id="post-<?php the_ID(); ?>">
                                <article class="u-gridCol6" >
                                    ...
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/XGl61pA_IsU?rel=0" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </article>
                                <div class="u-gridCol3">
                                    <div class="content-box">
                                        ...
                                        <div class="white-content">
                                            <p>Het team Van Ree Groenspecialisten bestaat uit Gerard en Bert van Ree 
                                                ...
                                                ze van elkaar mogen verwachten... <a href="/over-ons"> Lees meer >>></a>
                                            </p>
                                        </div> 
                                    </div>
                                </div>
                                 <div class="u-gridCol3">
                                        <div class="content-box"> 
                                            <div class="green-header-text green-header-text-resize">
                                                <p>LAATSTE NIEUWS</p>
                                            </div>
                             ...
                             <div class="keurmerkmargin">
                                    <div class="u-gridCol3 keurmerk">
                                     ...
                                     <div class="u-gridCol3 keurmerk">
                                            ...
                                            <a href="http://www.appeltern.nl/" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo-site.png" style="width: 20%;"></a>
